...
const file_api_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x11api/v1/auth.proto\x12\x06api.v1\x1a6github.com/mwitkow/go-proto-validators/validator.proto\x1a\x1cgoogle/api/annotations.proto\"V\n" +
	"\fLoginRequest\x12\"\n" +
	"\busername\x18\x01 \x01(\tB\x06\xe2\xdf\x1f\x02X\x01R\busername\x12\"\n" +
	"\bpassword\x18\x02 \x01(\tB\x06\xe2\xdf\x1f\x02X\x01R\bpassword\"%\n" +
	"\rLoginResponse\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token2Y\n" +
	"\vAuthService\x12J\n" +
	"\x05Login\x12\x14.api.v1.LoginRequest\x1a\x15.api.v1.LoginResponse\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/loginB\x0fZ\rapi/v1;api_v1b\x06proto3"
