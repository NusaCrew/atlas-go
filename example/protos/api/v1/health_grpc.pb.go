...
const (
	HealthService_Health_FullMethodName = "/api.v1.HealthService/Health"
)
...
func (c *healthServiceClient) Health(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedHealthServiceServer) Health(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
